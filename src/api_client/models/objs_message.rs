...
pub struct ObjsMessage {
    ...
    pub attachments: Option<Vec<crate::api_client::models::ObjsMessageAttachments>>,
    ...
    pub bot_profile: Option<Box<crate::api_client::models::ObjsBotProfile>>,
    #[serde(rename = "client_msg_id", skip_serializing_if = "Option::is_none")]
    pub client_msg_id: Option<String>,
    #[serde(rename = "comment", skip_serializing_if = "Option::is_none")]
    pub comment: Option<Box<crate::api_client::models::ObjsComment>>,
    #[serde(rename = "display_as_bot", skip_serializing_if = "Option::is_none")]
    pub display_as_bot: Option<bool>,
    #[serde(rename = "file", skip_serializing_if = "Option::is_none")]
    pub file: Option<Box<crate::api_client::models::ObjsFile>>,
    #[serde(rename = "files", skip_serializing_if = "Option::is_none")]
    pub files: Option<Vec<crate::api_client::models::ObjsFile>>,
    #[serde(rename = "icons", skip_serializing_if = "Option::is_none")]
    pub icons: Option<Box<crate::api_client::models::ObjsMessageIcons>>,
    ...
    pub user_profile: Option<Box<crate::api_client::models::ObjsUserProfileShort>>,
