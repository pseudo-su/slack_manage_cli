...
pub async fn users_identity(configuration: &configuration::Configuration, token: Option<&str>) -> Result<crate::api_client::models::UsersIdentitySchema, Error<UsersIdentityError>> {
    let local_var_configuration = configuration;
