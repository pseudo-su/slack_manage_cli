...
pub enum UsersListError {
    DefaultResponse(crate::api_client::models::UsersListErrorResponseBody),
    UnknownValue(serde_json::Value),
}


/// Lists all users in a Slack team.
pub async fn users_list(configuration: &configuration::Configuration, token: Option<&str>, limit: Option<i32>, cursor: Option<&str>, include_locale: Option<bool>) -> Result<crate::api_client::models::UsersListResponseBody, Error<UsersListError>> {
