...
pub struct ObjsUserProfile {
    ...
    #[serde(rename = "status_default_text_canonical", skip_serializing_if = "Option::is_none")]
...
impl ObjsUserProfile {
    pub fn new(avatar_hash: String, display_name: String, display_name_normalized: String, fields: Vec<serde_json::Value>, phone: String, real_name: String, real_name_normalized: String, skype: String, status_emoji: String, status_text: String, title: String) -> ObjsUserProfile {
        ObjsUserProfile {
            always_active: None,
            api_app_id: None,
            avatar_hash,
